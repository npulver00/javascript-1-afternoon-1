...
function doubleCheck(array){
  for(var i = 0; i<array.length; i++){
    if(array.includes("chocolate")== false){array.push("chocolate")};
      }
      return array;
}
...
function looper (array){
  ...
  for(let i= 0; i < array.length; i++) {
    if (array[i] >= 100){mySum = mySum + array[i]}
    else if (array[i]%2==1){mySum += array[i]}
...
function outerFn (){
  return function(){return "Natalie"}
